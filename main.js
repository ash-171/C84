...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			up1();
			console.log("Car1 up - up arrow");
		}
		if(keyPressed == '40')
		{
			down1();
			console.log("Car1 down - down arrow");
		}
		if(keyPressed == '37')
		{
			left1();
			console.log("Car1 left - left arrow");
		}
		if(keyPressed == '39')
		{
			right1();
			console.log("Car1 right - right arrow");
		}
		if(keyPressed == '87')
		{
			up2();
			console.log("Car2 up - Key w");
		}
		if(keyPressed == '65')
		{
			left2();
			console.log("Car2 left - Key a");
		}
		if(keyPressed == '68')
		{
			right2();
			console.log("Car2 right - Key d");
		}
		if(keyPressed == '83')
		{
			down2();
			console.log("Car2 down - Key s");
		}
}
